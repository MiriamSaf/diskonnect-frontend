...
class EditProfileView {
  ...
  render(){
    const template = html`
      <disk-app-header title="Edit Profile" user=${JSON.stringify(Auth.currentUser)}></disk-app-header>
      <div class="page-content">        
        ${(this.user == null) ? html`
          <sl-spinner></sl-spinner>
        `:html`
          <div class = "profile-outer-div">
          <p><strong> Updated at:</strong> ${moment(Auth.currentUser.updatedAt).format('Do MMMM YYYY, h:mm a')}</p>
