...
class Toast {
  static init() {
    //how long toast msg will show for
    this.showDuration = 2.5; // create container element
    //creates a new div after root

    this.containerEl = document.createElement('div'); //id #toasts will be set

    this.containerEl.id = 'toasts'; // append to <body>

    document.body.appendChild(this.containerEl);
  } //content is the msg 
  //type is regular or error - if error is red with css styling elsewhere
...
class Auth {
  ...
  async signIn(userData) {
    ...
    _Router.default.init(); //looks at the data that came in the response


    if (data.user.newUser == true) {
      //if new user - redirect to guide page - / guide
      (0, _Router.gotoRoute)('/guide');
    } else {
      //not new user - existing/returning user - /home
      (0, _Router.gotoRoute)('/');
    }
  }
  ...
  async check(success) {
    ...
    }); // if response not ok - ot valid

    if (!response.ok) {
      // console log error
      const err = await response.json();
      if (err) console.log(err); // delete local token as is invalid
...
class Utils {
  ...
  homeExtraAnim() {
    ...
    _gsap.default.from('.home-search-hikes', {
      opacity: 0,
      x: 30,
      ease: "powerout",
      duration: 0.5
    ...
    _gsap.default.from('.home-pic-box', {
      opacity: 0,
      y: 50,
      ease: "powerout",
      duration: 0.6
    ...
    _gsap.default.from('.footer-main', {
      opacity: 0,
      y: -50,
      ease: "powerout",
      duration: 0.5
    ...
    _gsap.default.from('.footer-right sl-icon', {
      opacity: 0,
      y: -50,
      ease: "powerin",
      duration: 1,
  ...
  hikesExtraAnim() {
    ...
    _gsap.default.from('.filter-menu div', {
      opacity: 0,
      y: 50,
      ease: "power1",
      duration: 0.6
  ...
  aboutExtraAnim() {
    _gsap.default.from('.mission-statement h1', {
      opacity: 0,
      y: -50,
      ease: "power1",
      duration: 1
    ...
    _gsap.default.from('.mission-statement', {
      opacity: 0,
      y: 50,
      ease: "power1",
      duration: 1.5
    ...
    _gsap.default.from('.about-hike-pic', {
      opacity: 0,
      y: -50,
      ease: "power1",
      duration: 1.5
...
class HomeView {
  init() {
    ...
    _Utils.default.pageIntroAnim(); //unique animation just for home entry page 


    _Utils.default.homeExtraAnim();
  } //render shows whats visible


  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), () => (0, _Router.gotoRoute)('/hike'), _App.default.apiBase);
...
class AboutView {
  init() {
    ...
    _Utils.default.pageIntroAnim(); //extra gsap


    _Utils.default.aboutExtraAnim();
  }

  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
class SignInView {
  init() {
    ...
    document.title = 'Sign In'; //this refers to the class
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["<h3>Bio</h3>\n        <p>", "</p>"]);
...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["\n          <sl-avatar style=\"--size: 210px; margin-bottom: 1em; margin-top: 1em;\" image=", "></sl-avatar>\n        "]);
...
class UserAPI {
  ...
  async addFavHike(hikeId) {
    ...
    if (!hikeId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/addFavHike"), {
      //PUT bc updating
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
    ...
    const data = await response.json(); // return data - json object being sent back from User model - backend
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <disk-app-header title=\"Edit Profile\" user=", "></disk-app-header>\n      <div class=\"page-content\">        \n        ", "\n        \n      </div>\n    "]);
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('Do MMMM YYYY, h:mm a'), this.updateProfileSubmitHandler.bind(this), this.user.avatar ? (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject5()), this.user.firstName, this.user.lastName, this.user.email, this.user.bio));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <disk-app-header title=\"Guide\" user=\"", "\"></disk-app-header>\n      <div class=\"page-content calign\">        \n        <h1>Guide</h1>\n        <h3 class=\"brand-color\">Welcome ", "!</h3>\n          <p>This is a quick tour to teach you the basics of using the Diskonnect site</p>\n\n          <div class=\"guide-step\">\n            <h4>Find a Hike</h4>\n            <img src=\"", "/images/hikePage.PNG\">\n          </div>\n\n          <div class=\"guide-step\">\n            <h4>Save hike to favourites</h4>\n            <img src=\"", "/images/FavBtn.PNG\">\n          </div>\n\n          <div class=\"guide-step\">\n            <h4>View Profile</h4>\n            <img src=\"", "/images/profilePage.PNG\">\n          </div>\n\n          <sl-button type=\"primary\" @click=", ">Yes I've got it!</sl-button>\n\n\n        \n      </div>      \n    "]);
...
class favouriteHikes {
  init() {
    ...
    _Utils.default.pageIntroAnim(); //call the fav function
  ...
  async getFavHikes() {
    try {
      ...
      const currentUser = await _UserAPI.default.getUser(_Auth.default.currentUser._id); //reassign favHikes value to array of fav hikes

      this.favHikes = currentUser.favouriteHikes;
      console.log(this.favHikes); //rerender page
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.favHikes == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.favHikes.map(hikes => (0, _litHtml.html)(_templateObject4(), hikes._id, hikes.image, hikes.title, hikes.description, hikes.location, hikes.stars, hikes.time, hikes.hikeDistance, hikes.skillLevel))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
class HikeAPI {
  ...
  async newHike(formData) {
    // send fetch request
    const response = await fetch("".concat(_App.default.apiBase, "/hike"), {
      //using POST method
      method: 'POST',
...
var _default = new HikeAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/hikes.js":[function(require,module,exports) {
"use strict";
...
var _HikeAPI = _interopRequireDefault(require("../../HikeAPI"));
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n       <style>\n        .filter-menu{\n          display: flex;\n          align-items: center;\n          \n        }\n\n        .filter-menu > div {\n          margin-right: 1em;\n        }\n\n      </style>\n      <disk-app-header title=\"Hikes\" user=\"", "\"></disk-app-header>\n      <div class=\"page-content\"> \n        <div class = \"fav-header-section\">\n          <h1 class = \"hike-h1\">Search Hikes</h1>\n       \n        <div class = \"filter-menu\">\n          <div class = \"filter-title\">\n            Filter: \n          </div>\n           <!-- Hike distance -->\n          <div class = \"length-full-screen\">\n            <strong>Length</strong>\n              <sl-button class =\"filter-btn\" size =\"small\" data-field =\"hikeDistance\" data-match =\"0-1\" @click=", ">0-1 km</sl-button>\n              <sl-button class =\"filter-btn\" size =\"small\" data-field =\"hikeDistance\" data-match =\"1-2\" @click=", ">1-2 km</sl-button>\n              <sl-button class =\"filter-btn\" size =\"small\" data-field =\"hikeDistance\" data-match =\"2-3\" @click=", ">2-3 km</sl-button>\n              <sl-button class =\"filter-btn\" size =\"small\" data-field =\"hikeDistance\" data-match =\"3-100\" @click=", ">3+ km</sl-button>\n          </div>\n          <!-- length/hike distance 2 (for responsiveness) -->\n          <div class = \"length-dropdown\">\n          <br>\n          <sl-dropdown distance=\"5\">\n            <sl-button class =\"filter-btn\" size = \"small\" slot=\"trigger\" style =\"margin-left: 0.5em;\" caret><strong>Length</strong></sl-button>\n            <sl-menu>\n              <sl-menu-item data-field =\"hikeDistance\" data-match=\"0-1\" @click=", ">0-1 km</sl-menu-item>\n              <sl-menu-item data-field =\"hikeDistance\" data-match=\"1-2\" @click=", ">1-2 km</sl-menu-item>\n              <sl-menu-item data-field =\"hikeDistance\" data-match=\"2-3\" @click=", ">2-3 km</sl-menu-item>\n              <sl-menu-item data-field =\"hikeDistance\" data-match=\"3-100\" @click=", ">3+ km</sl-menu-item>\n            </sl-menu>\n          </sl-dropdown>\n          </div>\n\n          <!-- time -->\n          <div class = \"time-full-screen\"> \n            <strong>Time</strong>\n              <sl-button class =\"filter-btn\" size =\"small\" data-field =\"time\" data-match =\"0-30\" @click=", ">0-30 mins</sl-button>\n              <sl-button class =\"filter-btn\" size =\"small\" data-field =\"time\" data-match =\"30-60\" @click=", ">30-60 mins</sl-button>\n              <sl-button class =\"filter-btn\" size =\"small\" data-field =\"time\" data-match =\"60-90\" @click=", ">1-1.5 hrs</sl-button>\n              <sl-button class =\"filter-btn\" size =\"small\" data-field =\"time\" data-match =\"90-1000\" @click=", ">1.5+ hrs</sl-button>\n          </div>\n          <!-- time 2 (for responsiveness) -->\n          <div class = \"time-dropdown\">\n          <br>\n          <sl-dropdown distance=\"5\">\n            <sl-button class =\"filter-btn\" size = \"small\" slot=\"trigger\" style =\"margin-left: 0.5em;\" caret><strong>Time</strong></sl-button>\n            <sl-menu>\n              <sl-menu-item data-field =\"time\" data-match=\"0-30\" @click=", ">0-30 mins</sl-menu-item>\n              <sl-menu-item data-field =\"time\" data-match=\"30-60\" @click=", ">30-60 mins</sl-menu-item>\n              <sl-menu-item data-field =\"time\" data-match=\"60-90\" @click=", ">1-1.5 hrs</sl-menu-item>\n              <sl-menu-item data-field =\"time\" data-match=\"90-1000\" @click=", ">1.5+ hrs</sl-menu-item>\n            </sl-menu>\n          </sl-dropdown>\n          </div>\n\n          <!-- skill level -->\n          <div class = \"skill-full-screen\">\n            <strong>Skill Level</strong>\n              <sl-button class =\"filter-btn\" size =\"small\" data-field =\"skillLevel\" data-match =\"Easy\" @click=", ">Easy</sl-button>\n              <sl-button class =\"filter-btn\" size =\"small\" data-field =\"skillLevel\" data-match =\"Moderate\" @click=", ">Moderate</sl-button>\n              <sl-button class =\"filter-btn\" size =\"small\" data-field =\"skillLevel\" data-match =\"Advanced\" @click=", ">Advanced</sl-button>\n          </div>\n           <!-- skill level 2 - dropdown (for responsiveness) -->\n          <div class = \"skill-lev-dropdown\">\n          <br>\n          <sl-dropdown distance=\"5\">\n            <sl-button class =\"filter-btn\" size = \"small\" slot=\"trigger\" style =\"margin-left: 0.5em;\" caret><strong>Level</strong></sl-button>\n            <sl-menu>\n              <sl-menu-item data-field =\"skillLevel\" data-match=\"Easy\" @click=", ">Easy</sl-menu-item>\n              <sl-menu-item data-field =\"skillLevel\" data-match=\"Moderate\" @click=", ">Moderate</sl-menu-item>\n              <sl-menu-item data-field =\"skillLevel\" data-match=\"Advanced\" @click=", ">Advanced</sl-menu-item>\n            </sl-menu>\n          </sl-dropdown>\n          </div>\n          \n          <!-- stars -->\n          <div class = \"stars-section\">\n          <strong>Stars</strong>\n          <sl-dropdown distance=\"5\">\n            <sl-button class =\"filter-btn\" size = \"small\" slot=\"trigger\" style =\"margin-left: 0.5em;\" caret><strong>Stars</strong></sl-button>\n            <sl-menu>\n              <sl-menu-item data-field =\"stars\" data-match=\"1\" @click=", ">1</sl-menu-item>\n              <sl-menu-item data-field =\"stars\" data-match=\"2\" @click=", ">2</sl-menu-item>\n              <sl-menu-item data-field =\"stars\" data-match=\"3\" @click=", ">3</sl-menu-item>\n              <sl-menu-item data-field =\"stars\" data-match=\"4\" @click=", ">4</sl-menu-item>\n              <sl-menu-item data-field =\"stars\" data-match=\"5\" @click=", ">5</sl-menu-item>\n            </sl-menu>\n          </sl-dropdown>\n          </div>\n\n            <!-- star 2 - dropdown (for responsiveness) -->\n          <div class = \"star-tablet-dropdown\">\n          <br>\n          <sl-dropdown class = \"star-btn-tablet\" distance=\"5\">\n            <sl-button class =\"filter-btn\" size = \"small\" slot=\"trigger\" style =\"margin-left: 0.5em;\" caret><strong>Stars</strong></sl-button>\n            <sl-menu>\n            <sl-menu-item data-field =\"stars\" data-match=\"1\" @click=", ">1</sl-menu-item>\n              <sl-menu-item data-field =\"stars\" data-match=\"2\" @click=", ">2</sl-menu-item>\n              <sl-menu-item data-field =\"stars\" data-match=\"3\" @click=", ">3</sl-menu-item>\n              <sl-menu-item data-field =\"stars\" data-match=\"4\" @click=", ">4</sl-menu-item>\n              <sl-menu-item data-field =\"stars\" data-match=\"5\" @click=", ">5</sl-menu-item>\n            </sl-menu>\n          </sl-dropdown>\n          </div>\n         \n        </div><!-- close filter menu div -->\n        <sl-button class = \"clear-fltr\" size = \"small\" @click = ", ">Clear Filters</sl-button>\n        </div><!-- close hike header div -->\n        \n\n        <div class=\"hike-grid\">\n        ", "\n        </div> <!-- close hike grid div-->\n      </div><!-- close page content div -->      \n    "]);
...
class HikeView {
  async init() {
    document.title = 'Hikes'; //this refers to this class
    //will store hikes when come in from backend

    this.hikes = null;
    this.render();

    _Utils.default.pageIntroAnim(); //call func below


    await this.getHikes(); //gsap animation specific for this view

    _Utils.default.hikesExtraAnim();
  } //filter hikes by the field and match


  async filterHikes(field, match) {
    //validate that inputs are there
    if (!field || !match) return; //get fresh hikes copy 

    this.hikes = await _HikeAPI.default.getHikes();
    console.log('field: ' + field);
    console.log('match: ' + match);
    let filteredHikes; //check stars field
    ...
    if (field == 'hikeDistance') {
      ...
      console.log(hikeRangeStart, hikeRangeEnd); //if price is greater than or = to start and less than equal to end range
    ...
    if (field == 'time') {
      ...
      console.log(timeRangeStart, timeRangeEnd); //if price is greater than or = to start and less than equal to end range
    ...
    console.log(filteredHikes); //render
  ...
  handleFilterBtn(e) {
    //clear filter btns
    this.clearFilterBtns(); //console.log(e.target)
    //set btn as primary type for sl stlying full colour ACTIVE

    e.target.setAttribute('type', 'primary'); //extract the data field from the btn

    const field = e.target.getAttribute('data-field'); //grab the match field from the btn

    const match = e.target.getAttribute('data-match'); //console.log('field = '+field)
    //console.log('match= '+match)
    //filter hikes
  ...
  async getHikes() {
    try {
      ...
      this.hikes = await _HikeAPI.default.getHikes();
      console.log(this.hikes); //must rerender page
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.clearFilters.bind(this), this.hikes == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.hikes.map(hikes => (0, _litHtml.html)(_templateObject4(), hikes._id, hikes.location, hikes.title, hikes.stars, hikes.image, hikes.skillLevel, hikes.time, hikes.hikeDistance, hikes.description))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new HikeView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../HikeAPI":"HikeAPI.js","../../Toast":"Toast.js"}],"views/pages/newDiskonnectHike.js":[function(require,module,exports) {
"use strict";
...
class newHike {
  ...
  async newHikeSubmitHandler(e) {
    ...
    e.preventDefault(); //want to send form handler to Hike.API page

    const submitBtn = document.querySelector('.submit-btn'); //adds loading animation

    submitBtn.setAttribute('loading', ''); //grab form data from e attribute  

    const formData = e.detail.formData; //this will take time so must make a try and catch

    try {
      //pass in data through HikeAPI function
      await _HikeAPI.default.newHike(formData);

      _Toast.default.show('Hike added!'); //remove loading btn


      submitBtn.removeAttribute('loading'); //then reset the form - its a custom form 
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.newHikeSubmitHandler);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new newHike();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../Toast":"Toast.js","./../../HikeAPI":"HikeAPI.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _newDiskonnectHike = _interopRequireDefault(require("./views/pages/newDiskonnectHike"));
...
const routes = {
  ...
  '/hike': _hikes.default,
  '/newHike': _newDiskonnectHike.default
};
...
const AppRouter = new Router(); //export as defualt export
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["<a href=\"/newHike\" @click=\"", "\">Add Hike</a> "]);
...
customElements.define('disk-app-header', class AppHeader extends _litElement.LitElement {
  constructor() {
    super();
  }
...
customElements.define('va-hike', class Diskonnect extends _litElement.LitElement {
  ...
  moreInfoHandler() {
    //create sl-dialog
    const dialogEL = document.createElement('sl-dialog'); //class name added

    dialogEL.className = 'disk-dialog'; //sl-dialog content

    const dialogContent = (0, _litElement.html)(_templateObject(), _App.default.apiBase, this.image, this.title, this.title, this.description, this.location, this.stars, this.hikeDistance, this.time, this.skillLevel, this.addFavHandler.bind(this)); //render the html content inside our dialogEl above

    (0, _litHtml.render)(dialogContent, dialogEL); //append to document body but not visible yet - need show method

    document.body.append(dialogEL); //show sl-dialog

    dialogEL.show(); //on hide delete dialog el
  ...
  async addFavHandler() {
    try {
      ...
      await _UserAPI.default.addFavHike(this.id);

      _Toast.default.show('Hike added to favourites');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  ...
  render() {
    return (0, _litElement.html)(_templateObject2(), _App.default.apiBase, this.image, this.title, this.stars, this.description, this.moreInfoHandler.bind(this));
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","../Router":"Router.js","../Auth":"Auth.js","../App":"App.js","./../Toast":"Toast.js","./../UserAPI":"UserAPI.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
require("./components/disk-app-header");

require("./components/va-hike");
...
},{"./App.js":"App.js","./components/disk-app-header":"components/disk-app-header.js","./components/va-hike":"components/va-hike.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
