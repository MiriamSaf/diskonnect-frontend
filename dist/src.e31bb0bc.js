...
function _templateObject2() {
  const data = _taggedTemplateLiteral(["<p class=\"time\"><span>", "</span> mins</p>"]);
...
customElements.define('va-hike', class Diskonnect extends _litElement.LitElement {
  ...
  moreInfoHandler() {
    ...
    const dialogContent = (0, _litElement.html)(_templateObject(), _App.default.apiBase, this.image, this.title, this.title, this.description, this.location, this.stars, this.hikeDistance, this.time < 60 ? (0, _litElement.html)(_templateObject2(), this.time) : "".concat(this.time / 60, " hours"), this.skillLevel, this.addFavHandler.bind(this)); //render the html content inside our dialogEl above
  ...
  render() {
    return (0, _litElement.html)(_templateObject3(), _App.default.apiBase, this.image, this.title, this.stars, this.description, this.moreInfoHandler.bind(this));
  }
